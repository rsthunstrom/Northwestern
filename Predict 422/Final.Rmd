...
A very similar ROC curve ensues, but we have acheived our highest profit total so far, albeit it only by a small margin.  
...
Feature | Logistic Regression | L2 | Logistic Regression
:------|:------------|:---------------
