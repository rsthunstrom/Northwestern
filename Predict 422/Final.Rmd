...
It's obvious to see that the performance of this model is significantly better.  We achieve the highest profit so far by a wide margin, at $11,790.  This is because we can predict basically the same amount of responders, 979 of them, with significantly less circulation.  

$$14.5* 979 (Responders) - 2* 1230(Total Mail Circulation) = 11,790.00 (Profit)$$
...
#regression column 2 is RSS, classification deviance
